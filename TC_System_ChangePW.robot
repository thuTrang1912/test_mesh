...
2. Change Password administrator
	...
	Change Administrator Password           ${PassWord}    ${New_PW_WebGUI}     ${New_PW_WebGUI}
	Should Return to the login page After change PW
	${PassWord} =    Set variable   ${New_PW_WebGUI}
	Set global Variable             ${PassWord}
3. ReLogin WebGUI by new Password
	Reload Page
	Chrome Pass Certificate google if present
    Login To WebGUI on local machine         root       ${New_PW_WebGUI}
