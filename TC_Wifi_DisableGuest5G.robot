...
2. Disable Guest SSID 5G
    Access Setting Page
    Open Wireless Guest SSID 5G Setting
    Log To Console      \nCheck Guest 5G are Enable or NOT
    ${Stt}              Run Keyword And Return Status    Checkbox Should Be Selected    //input[@id='5G_Enable_Guest']
    Log To Console      \n Checkbox Should Be Selected: ${Stt}
    IF    ${Stt}
          Unselect Checkbox    //input[@id='5G_Enable_Guest']
    ELSE
...
3. Verify in WebGui
    ...
    END
    Should Be True    ${Stt}
    #Element Should Be Disabled          xpath= //input[@id='Input_SSID']
#    Page Should Not Contain Element         xpath= //input[@id='Input_SSID']
    Page Should Not Contain    ${Guest5_SSID}
4. Verify on client dose not detect wifi Guest 24G
    Open SSH Session Login To Local Machine
    Sleep    5
    SSH_Connect_wifi.Enable Wifi
    Wait Until Keyword Succeeds   180    5    Wifi Rescan Not Contain       ${Guest5_SSID}
